...
pkg install wget -y
pkg clean
git clone https://github.com/GEEKMDXINC/SLG_MD-AI
cd SLG_MD-AI
npm install
npm start
```
...
1. **Cloning the Repository**:
   - `git clone https://github.com/GEEKMDXINC/SLG_MD-AI`: Clones the repository into the current directory.
   - `cd SLG_MD-AI`: Changes the directory to the cloned repository folder.
